export default {
    ...
    'homeTitle': 'The ETHERLUCKY Based on Smart Contract platform, ETHERLUCKY is the first platform integrate DAPP Game included Digital Lottery which is officially launched in October.',
    'videoDescription': 'ETHERLUCKY created financial games named LUCKY NUMBER, LUCKY DICE, LUCKY RING and LUCKY MOON which are blockchain Smart Contract-based LUCKYNUMBER and it is aid participants not merely entertain after having a tiring day tim but also as well increase their particular income in a easy approach.Using blockchain technology discover how to architect and develop private permissioned blockchain networks for the enterprise to handle business-to-business transactions while maintaining security, privacy and confidentiality for every users.',
